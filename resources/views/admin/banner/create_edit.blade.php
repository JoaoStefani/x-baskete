...
<!-- ./ tabs -->
@if (isset($banner))
{!! Form::model($banner, array('url' => URL::to('admin/banner') . '/' . $banner->id.'/update', 'method' => 'put','id'=>'fupload', 'class' => 'bf', 'files'=> true)) !!}
@else
    ...
    <div class="tab-pane active" id="tab-general">
        ...
        <div class="form-group  {{ $errors->has('ativo') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                ...
                {!! Form::radio('ativo', '1', @isset($banner)? $banner->ativo : 'false') !!}
                {!! Form::label('ativo', 'Não', array('class' => 'control-label')) !!}
                {!! Form::radio('ativo', '0', @isset($banner)? $banner->ativo : 'true') !!}
